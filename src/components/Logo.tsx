...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const logoSrc = variant === 'light'
    ? "https://raw.githubusercontent.com/yamanozgur/visaflow-web/main/viflo_white_vt.png"
    : "https://raw.githubusercontent.com/yamanozgur/visaflow-web/main/viflo_gr_vt.png";
